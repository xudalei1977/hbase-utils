...
public class HBaseRowCounter {
     ...
     * args 1: table name, e.g. test1
     * args 2: hbase table start row, e.g. user1|ts1
     * args 3: hbase table stop row, e.g. user1|ts7
     * args 4: hbase table column name, e.g. sf:c1
     * args 5: hbase table column value, e.g. sku1
     * sample: java -classpath hbase-utils-1.0-SNAPSHOT-jar-with-dependencies.jar HBaseRowCounter 10.0.0.193 test1 "user1|ts1" "user1|ts3" "sf:c1" sku1
     **/
    public static void main(String[] args) throws IOException {
        init(args[0]);
        long rowCount = 0L;
        System.out.println("the row count is := " + args.length);
